import pytest
from test_todo_app.utils.helpers import parse_styled_text, build_styled_text, toggle_prefix_emoji
...
@pytest.mark.parametrize("input_text,expected", [
    ...
    (":red[ciao]", {"text": "ciao", "bold": False, "italic": False, "color": "red"}),
    (":blue[**ciao**]", {"text": "ciao", "bold": True, "italic": False, "color": "blue"}),
    (":green[*ciao*]", {"text": "ciao", "bold": False, "italic": True, "color": "green"}),
])
...
@pytest.mark.parametrize("input_dict,expected", [
    ...
    ({"text": "ciao", "bold": False, "italic": False, "color": "red"}, ":red[ciao]"),
    ({"text": "ciao", "bold": True, "italic": True, "color": "blue"}, ":blue[***ciao***]"),
