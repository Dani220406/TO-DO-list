...
@pytest.fixture
def mock_st(mocker):
    st = mocker.patch("test_todo_app.main.st")
...
def test_main_calls_welcome_screen(mock_st, mocker):
    ...
    welcome_mock = mocker.patch("test_todo_app.main.welcome_screen")
    home_mock = mocker.patch("test_todo_app.main.home")

    # Importiamo main DOPO aver patchato st e le schermate
    from test_todo_app.main import main
    main()
